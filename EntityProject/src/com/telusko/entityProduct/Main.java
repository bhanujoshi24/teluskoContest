...
//		Get Product Based on Place
		System.out.println("==============================================");
		System.out.println("Getting All Product whose place is Black Table");
		service.getProductByPlace("black Table").forEach(p -> System.out.println(p));
		
//		Get Product Out of Warrenty
		System.out.println("==============================================");
		System.out.println("Getting Product out of Warrenty");
		service.getProductOutOfWarrenty().forEach(p-> System.out.println(p));
